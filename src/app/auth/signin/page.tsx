            ...
            >
                ...
                >
                    ...
                    <div className="mt-6">
                        <button
                            ...
                            disabled={isLoading}
                            className="w-full inline-flex justify-center items-center py-3 px-4 border border-gray-200 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black disabled:opacity-50 transition-all duration-200"
                        >
                ...
                >
                    <p className="text-sm text-gray-600">
                        ...
                        <Link href="/auth/signup" className="font-medium text-black hover:text-gray-900 transition-colors">
                            Sign up
                        </Link>
                    </p>
                </motion.div>
